...
# Castear columnas numéricas — el MCP devuelve todo como strings
_su_numeric_cols = ["latitude", "longitude", "transacciones", "consumo_total",
                    "ticket_promedio", "days_to_first_trx"]
...
# Castear columnas numéricas — el MCP devuelve todo como strings
_tx_numeric_cols = ["latitude", "longitude", "total_amount", "bizne_fee"]
